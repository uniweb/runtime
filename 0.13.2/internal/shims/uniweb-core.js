...
export const Tracker = __ns.Tracker
...
export const resolveQueryAddress = __ns.resolveQueryAddress
export const resolveRecordAddressPattern = __ns.resolveRecordAddressPattern
